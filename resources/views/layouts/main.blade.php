                ...
                <ul class="navbar-nav">
                  <li class="nav-item dropdown active"><a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">Home</a>
                    <ul class="dropdown-menu">
                      ...
                      <li class="dropdown position-static mb-0"><a class="dropdown-item py-2 border-bottom" href="home-electronics-store"><span class="d-block text-heading">Electronics Store</span><small class="d-block text-muted">Slider + Promo banners</small></a>
                        <div class="dropdown-menu h-100 animation-none mt-0 p-3"><a class="d-block" href="home-electronics-store" style="width: 250px;"><img src="{{asset('frontend/img/home/preview/th03.jpg')}}" alt="Electronics Store"></a></div>
                      </li>
                        ...
                        <div class="mega-dropdown-column pt-1 pt-lg-4 px-2 px-lg-3">
                          <div class="widget widget-links mb-4">
                            ...
                            <ul class="widget-list">
                              ...
                              <li class="widget-list-item"><a class="widget-list-link" href="shop-cart">Cart</a></li>
                              ...
                              <li class="widget-list-item"><a class="widget-list-link" href="order-tracking">Order Tracking</a></li>
                    ...
                    <ul class="dropdown-menu">
                      <li class="dropdown"><a class="dropdown-item dropdown-toggle" href="#" data-bs-toggle="dropdown">Navbar Variants</a>
                        <ul class="dropdown-menu">
                          ...
                          <li><a class="dropdown-item" href="home-electronics-store">Electronics Store</a></li>
